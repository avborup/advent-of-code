...
defmodule Parsing do
  ...
  defp parse_test(test_line) do
    [_, num] = String.split(test_line, "by ")
    num = String.to_integer(num)

    fn n -> rem(n, num) == 0 end
  end
